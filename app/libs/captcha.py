...
class Captcha(object):
    ...
    def initialize(self, width=200, height=75, color=None, text=None, fonts=None):
        ...
        self._text = text if text else random.sample('123456789', 5)
        self.fonts = fonts if fonts else [os.path.join(self._dir, 'fonts', font) for font in ['actionj.ttf']]
        self.width = width
        self.height = height
    ...
    def text(self, image, fonts, font_sizes=None, drawings=None, squeeze_factor=0.75, color=None):
        ...
        for char_image in char_images:
            ...
            mask = char_image.convert('L').point(lambda i: i * 2)
